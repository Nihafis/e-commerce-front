                ...
                <Center>
                    <ColumnsWrapper>
                        <Box>
                            ...
                            <p> we will email you when order will be sent</p>
                        </Box>
                    </ColumnsWrapper>
                    ...
                    {!!cartProducts?.length && (
                        <Box>
                            ...
                            <CityHolder>
                                ...
                                <Input type="text" placeholder="Posta Code" value={postalcode} name='postalcode' onChange={ev => setPostalcode(ev.target.value)} />
                            </CityHolder>
